...
export const dev = gulp.series(clean, gulp.parallel(scripts, styles, images, copy), serve, watch);
export const build = gulp.series(clean, gulp.parallel(scripts, styles, images, copy));
